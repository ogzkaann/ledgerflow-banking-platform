...
public class TransferOutboxPublisher {
    private static final Logger LOGGER = LoggerFactory.getLogger(TransferOutboxPublisher.class);
    ...
    public void publishPending() {
        ...
        for (OutboxRow row : rows) {
            ...
            try {
                ...
                LOGGER.info(
                        "outbox_published service=transfer-service eventId={} eventType={} transferId={} status=PUBLISHED",
                        row.eventId(),
                        row.eventType(),
                        row.aggregateId());
                ...
                jdbc.update("""
                        ...
                        """, row.eventId());
                LOGGER.warn(
                        "outbox_publish_failed service=transfer-service eventId={} eventType={} transferId={} exceptionType={}",
                        row.eventId(),
                        row.eventType(),
                        row.aggregateId(),
