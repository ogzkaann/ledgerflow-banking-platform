package dev.oguzkaandere.ledgerflow.risk.support;
...
public abstract class RiskIntegrationTest {
    ...
    void clean() {
        ...
        jdbc.update("DELETE FROM risk_decisions");
    }
}
